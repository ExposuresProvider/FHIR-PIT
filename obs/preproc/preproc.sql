...
select widetolong('icd_asthma_norm', ARRAY['encounter_num','patient_num'], ARRAY['integer','integer'], 'icd_code', ARRAY['norm'], ARRAY['boolean'], ARRAY['_norm'], 'icd_asthma_norm_wide');
select widetolong('loinc', ARRAY['encounter_num','patient_num'], ARRAY['integer','integer'], 'concept',
		  ...
		  ARRAY['_valtype','_instance_num','_nval','_tval','_units','_start_date','_end_date'], 'loinc_wide');
select widetolong('mdctn', ARRAY['encounter_num','patient_num'], ARRAY['integer','integer'], 'concept',
		  ...
		  ARRAY['_valtype','_instance_num','_nval','_tval','_units','_start_date','_end_date','_modifier','_valueflag'], 'mdctn_wide');
