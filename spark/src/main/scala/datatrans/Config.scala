...
object Config {
  ...
  val stepConfigConfigMap: Map[String, StepConfigConfig] = Seq(PreprocFHIR, PreprocPerPatSeriesToVector, PreprocPerPatSeriesEnvData, PreprocPerPatSeriesEnvDataFIPS, PreprocFIPS, PreprocEnvDataFIPS, PreprocEnvDataAggregateFIPS, PreprocPerPatSeriesNearestRoad, PreprocPerPatSeriesNearestRoad2, PreprocPerPatSeriesACS, PreprocPerPatSeriesACS2, PreprocCSVTable, Train, Noop).map(c => (c.configType, c)).toMap
}
