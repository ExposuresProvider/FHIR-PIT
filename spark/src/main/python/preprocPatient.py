...
df["AgeStudyStart"] = pd.cut(df["AgeStudyStart"].apply(preprocHighwayExposure), [0, 3, 18, 35, 51, 70, 90], labels=['0-2', '3-17', '18-34', '35-50', '51-69', '70+'], include_lowest=True, right=False)
