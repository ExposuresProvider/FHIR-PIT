...
libraryDependencies += "org.nd4j" %% "nd4j-parameter-server-node" % "1.0.0-beta6"
libraryDependencies += "org.deeplearning4j" %% "dl4j-spark-parameterserver" % "1.0.0-beta6"
libraryDependencies += "org.datavec" %% "datavec-spark" % "1.0.0-beta6"
